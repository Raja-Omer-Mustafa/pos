...
class system_settings extends MY_Controller
{
    ...
    function __construct()
    {
        ...
        // var_dump($this->router->fetch_method() === 'categories');
        ...
        // var_dump($this->Admin);
        // var_dump($this->Owner === NULL);
        // var_dump($this->router->fetch_method() === 'index');
        // var_dump($this->Owner);

        // echo '<pre>';
        // echo print_r($this->Owner);
        // echo '<br>';
        // echo print_r($this->Admin);
        // echo '<br>';
        // echo print_r($this->loggedIn);
        // echo '<br>';
        // echo print_r($this->Customer);
        // echo '</pre>';

        //
        if ((!$this->Owner && $this->Admin === NULL) || 
            (
                $this->Admin && $this->Owner === NULL && 
                !($this->router->fetch_method() === 'categories') && 
                !($this->router->fetch_method() === 'getCategories') && 
                !($this->router->fetch_method() === 'add_category') &&
                !($this->router->fetch_method() === 'import_categories') &&
                !($this->router->fetch_method() === 'edit_category') &&
                !($this->router->fetch_method() === 'delete_category') &&
                !($this->router->fetch_method() === 'category_actions') &&

                !($this->router->fetch_method() === 'expense_categories') && 
                !($this->router->fetch_method() === 'getExpenseCategories') && 
                !($this->router->fetch_method() === 'add_expense_category') &&
                !($this->router->fetch_method() === 'edit_expense_category') &&
                !($this->router->fetch_method() === 'delete_expense_category') &&
                !($this->router->fetch_method() === 'expense_category_actions') &&

                !($this->router->fetch_method() === 'units') && 
                !($this->router->fetch_method() === 'getUnits') &&
                !($this->router->fetch_method() === 'add_unit') &&
                !($this->router->fetch_method() === 'edit_unit') &&
                !($this->router->fetch_method() === 'delete_unit') &&
                !($this->router->fetch_method() === 'unit_actions') &&

                !($this->router->fetch_method() === 'brands') && 
                !($this->router->fetch_method() === 'getBrands') &&
                !($this->router->fetch_method() === 'add_brand') &&
                !($this->router->fetch_method() === 'edit_brand') &&
                !($this->router->fetch_method() === 'delete_brand') &&
                !($this->router->fetch_method() === 'import_brands') &&
                !($this->router->fetch_method() === 'brand_actions') &&

                !($this->router->fetch_method() === 'variants') && 
                !($this->router->fetch_method() === 'getVariants') && 
                !($this->router->fetch_method() === 'add_variant') && 
                !($this->router->fetch_method() === 'edit_variant') && 
                !($this->router->fetch_method() === 'delete_variant') && 

                !($this->router->fetch_method() === 'tax_rates') && 
                !($this->router->fetch_method() === 'getTaxRates') && 
                !($this->router->fetch_method() === 'add_tax_rate') && 
                !($this->router->fetch_method() === 'edit_tax_rate') && 
                !($this->router->fetch_method() === 'delete_tax_rate') && 
                !($this->router->fetch_method() === 'tax_actions') && 
    ...
    function permissions($id = NULL)
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $data = array(
                ...
                'purchases-supplier_payment' => $this->input->post('purchases-supplier_payment'),
                'purchases-add_supplier_payment' => $this->input->post('purchases-add_supplier_payment'),
