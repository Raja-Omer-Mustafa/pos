                ...
                <div class="sidebar-nav nav-collapse collapse navbar-collapse" id="sidebar_menu">
                    <ul class="nav main-menu">
                        ...
                        if ($Owner || $Admin) {
                            ...
                            <li class="mm_purchases">
                                ...
                                <ul>
                                    ...
                                    <li id="purchases_supplier_payment">
                                        <a class="submenu" href="<?= admin_url('purchases/supplier_payment'); ?>">
                                            <i class="fa fa-star"></i>
                                            <span class="text"> <?= lang('list_payment'); ?></span>
                                        </a>
                                    </li>
                                    <li id="purchases_add_supplier_payment">
                                        <a class="submenu" href="<?= admin_url('purchases/add_supplier_payment'); ?>" data-toggle="modal" data-target="#myModal">
                                            <i class="fa fa-plus-circle"></i>
                                            <span class="text"> <?= lang('add_supplier_payment'); ?></span>
                                        </a>
                                    </li>
                            ...
                            <!-- <li class="mm_add_supplier_payment">
                                <a class="dropmenu" href="#">
                                    <i class="fa fa-money"></i>
                                    <span class="text"> <?= lang('payment'); ?>
                                    </span> <span class="chevron closed"></span>
                                </a>
                                <ul>
                                    <li id="supplier_payment">
                                        <a class="submenu" href="<?= admin_url('purchases/supplier_payment'); ?>">
                                            <i class="fa fa-star"></i>
                                            <span class="text"> <?= lang('list_payment'); ?></span>
                                        </a>
                                    </li>
                                    <li id="add_supplier_payment">
                                        <a class="submenu" href="<?= admin_url('purchases/add_supplier_payment'); ?>/17" data-toggle="modal" data-target="#myModal">
                                            <i class="fa fa-plus-circle"></i>
                        ...
                        <?php
                            ...
                            <?php if ($GP['purchases-index'] || $GP['purchases-add'] || $GP['purchases-expenses'] || $GP['purchases-supplier_payment']) { ?>
                            <li class="mm_purchases">
                                <a class="dropmenu" href="#">
                                    <i class="fa fa-star"></i>
                                    <span class="text"> <?= lang('purchases'); ?>
                                ...
                                <ul>
                                    ...
                                    <?php } ?>
                                    <?php if ($GP['purchases-supplier_payment']) { ?>
                                    <li id="purchases_supplier_payment">
                                        <a class="submenu" href="<?= admin_url('purchases/supplier_payment'); ?>">
                                            <i class="fa fa-star"></i>
                                            <span class="text"> <?= lang('list_payment'); ?></span>
                                    ...
                                    <?php } ?>
                                    <?php if ($GP['purchases-add_supplier_payment']) { ?>
                                    <li id="purchases_add_supplier_payment">
                                        <a class="submenu" href="<?= admin_url('purchases/add_supplier_payment'); ?>" data-toggle="modal" data-target="#myModal">
                                            <i class="fa fa-plus-circle"></i>
                                            <span class="text"> <?= lang('add_supplier_payment'); ?></span>
