                                ...
                                <div id="proContainer">
                                    <div id="ajaxproducts">
                                        ...
                                        <div class="btn-group btn-group-justified pos-grid-nav">
                                            ...
                                            <div class="btn-group">
                                                <button style="z-index:10003;" class="btn btn-primary pos-tip" type="button" id="extraSale" title="<?=lang('extra_sale')?>">
                                                    <i class="fa fa-shopping-cart" id="addIcon"></i> <?=lang('extra_sale')?>
                                                </button>
                                            </div>
...
<div class="modal fade in" id="esModal" tabindex="-1" role="dialog" aria-labelledby="mModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i
                        class="fa fa-2x">&times;</i></button>
                <h4 class="modal-title" id="myModalLabel"><?=lang('extra_sale');?></h4>
            </div>
            <div class="modal-body">
                <p><?=lang('enter_info');?></p>

                <div class="alert alert-danger error-con" style="display: none;">
                    <button data-dismiss="alert" class="close" type="button">×</button>
                    <span id="error"></span>
                </div>
                <div class="form-group">
                    <?= lang("product_code", "prod_code"); ?> *
                    <div class="input-group">
                        <?php echo form_input('prod_code', '', 'class="form-control" id="prod_code"'); ?>
                        <div class="input-group-addon" style="padding-left: 10px; padding-right: 10px;">
                            <a href="#" id="product_num"><i class="fa fa-random"></i></a>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <?=lang("product_name", "prod_name");?> *
                    <?php echo form_input('prod_name', '', 'class="form-control" id="prod_name"'); ?>
                </div>
                <div class="form-group">
                    <?=lang("price", "esprice");?> *
                    <?php echo form_input('esprice', '', 'class="form-control" id="esprice"'); ?>
                </div>
                <div class="form-group">
                    <?=lang("supplier", "essupplier");?>
                    <?php echo form_input('essupplier', '', 'class="form-control" id="essupplier"'); ?>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" id="addExtraSale" class="btn btn-primary"><?=lang('extra_sale')?></button>
            </div>
        </div>
    </div>
</div>
