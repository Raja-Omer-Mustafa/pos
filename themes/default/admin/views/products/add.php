            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-5">
                    <div class="form-group"> <!-- style="display:none" -->
                        ...
                        // $opts = array('hardware' => lang('hardware'), 'timber' => lang('timber'), 'sheets' => lang('sheets'), 'panel' => lang('panel'));
                    ...
                    <div class="form-group">
                        ...
                        <?php
                        $options = array('hardware' => lang('hardware'), 'timber' => lang('timber'), 'sheets' => lang('sheets'), 'panel' => lang('panel'));
                        echo form_dropdown('product_type', $options, (isset($_POST['product_type']) ? $_POST['product_type'] : ($product ? $product->product_type : '')), 'class="form-control" id="product_type" required="required"');
                        ?>
                    </div>
                    <div class="form-group all">
                        ...
                        <!-- <div class="input-group"> -->
                            ...
                            <!-- <span class="input-group-addon pointer" id="remove_event" style="padding: 1px 10px;">
...
//});
    ...
    $(document).ready(function() {
        ...
        // MakeTextBoxUrduEnabled(textbox);
        $(textbox).click(function() {
            console.log($(this).val());
            // MakeTextBoxUrduEnabled(document.getElementById("name"));
        });
        $('#remove_event').click(function() {
            MakeTextBoxUrduDisable(textbox);
