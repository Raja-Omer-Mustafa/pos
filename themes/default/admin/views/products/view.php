...
<?php if ($Owner || $Admin) { ?>
    <ul id="myTab" class="nav nav-tabs">
        ...
        <?php if($product->type == 'hardware' || $product->type == 'timber' || $product->type == 'sheets' || $product->type == 'panel') { ?>
                            ...
                            <div class="col-sm-12">
                                <div class="row">
                                    <div class="col-sm-5">
                                        ...
                                        <?php if ((!$Supplier || !$Customer) && !empty($warehouses) && ($product->type == 'hardware' || $product->type == 'timber' || $product->type == 'sheets' || $product->type == 'panel')) { ?>
