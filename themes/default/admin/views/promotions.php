        ...
        <div class="site-wrapper-inner">
            <div class="cover-container">
                ...
                <div class="inner cover">
                    ...
                    <p class="lead"><?= $Settings->site_name; ?> is a Hardware company which deals with selling wood articles, Locks, Screws and other goods</p>
                    <!-- <p>Please edit themes/<?=$Settings->theme;?>/views/promotions.php</p> -->
                </div>
                <div class="mastfoot">
                    <div class="inner">
                        <p><?= $Settings->site_name; ?> by <a href="http://graystork.com/">Graystork</a>.</p>
                    </div>
                </div>
            </div>
        </div>
