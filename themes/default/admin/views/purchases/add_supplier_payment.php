...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('add_supplier_payment'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
        echo admin_form_open_multipart("purchases/add_supplier_payment/" , $attrib); ?>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <!-- <div class="input-group"> -->
                            <input type="text" name="supplier" id="posupplier"
...
<script type="text/javascript" charset="UTF-8">
    $(document).ready(function () {
        ...
        //     // console.log(localStorage.getItem('posupplier'));
        //     // console.log(localStorage.getItem('supplier_id'));
