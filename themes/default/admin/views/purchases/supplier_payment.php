...
<script>
    ...
    $(document).ready(function () {
        ...
        oTable = $('#PayRData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('purchases/get_supplier_payments/?v=1' . $v) ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-money"></i><?= lang('list_payment'); ?> <?php
            if ($this->input->post('start_date')) {
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo admin_form_open("purchases/supplier_payment"); ?>
                    <div class="row">
                        <div class="col-sm-4">
