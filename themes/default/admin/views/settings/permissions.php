                            ...
                            <table class="table table-bordered table-hover table-striped reports-table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="checkbox" value="1" id="purchases-supplier_payment" class="checkbox" name="purchases-supplier_payment" <?php echo $p->{'purchases-supplier_payment'} ? "checked" : ''; ?>>
                                        <label for="purchases-supplier_payment" class="padding05"><?= lang('list_payment') ?></label>

                                        <input type="checkbox" value="1" id="purchases-add_supplier_payment" class="checkbox" name="purchases-add_supplier_payment" <?php echo $p->{'purchases-add_supplier_payment'} ? "checked" : ''; ?>>
                                        <label for="purchases-add_supplier_payment" class="padding05"><?= lang('add_supplier_payment') ?></label>
                                    </td>
                                </tr>
